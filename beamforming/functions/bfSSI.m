function [IQOut,BFConfig] = bfSSI(RcvData,varargin)
...
BFConfig=makeBFConfig('WideNSSI');
...
isCompile=1;
k=PTXCreate(isCompile,BFConfig.kernel_name,[BFConfig.Nz,BFConfig.Nx,BFConfig.Ny],128,16*128);

%% Demodulate
try
    modeSSI=evalin('base','modeSSI');
